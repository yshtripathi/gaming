            ...
            action="{{route('login.submit')}}" method="post" class="row mt-4 align-items-center">
                ...
                <div class="col-sm-6 text-sm-start">
                  <div class="mb-3 form-check">
                    ...
                    <label class="form-check-label" for="exampleCheck1">{{ __('common.keep_me_logged_in') }}</label>
                  </div>
                </div>
                <div class="col-sm-6 mb-0 mb-sm-3 text-end"><a href="#">{{ __('common.forget_password') }}</a></div>
